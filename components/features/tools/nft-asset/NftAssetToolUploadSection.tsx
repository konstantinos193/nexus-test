  ...
  return (
    ...
    >
      ...
      <div
        ...
        onDrop={onDrop}
      >
        <p className="nft-asset-tool-upload-text">
          {layers.length > 0
            ? exclusionRulesCount > 0
              ? `${layers.length} layers · ${validCombinationCount} valid of ${totalCombinations}`
              : `${layers.length} layers · ${totalCombinations} combinations`
