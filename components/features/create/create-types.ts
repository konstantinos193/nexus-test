/**
 * Shared types and helpers for the Create Collection flow.
 * Used by CreatePageContent and step components (CreateStep1Details, etc.).
 */
...
/** Validation for Secondary Royalty Split: sum = 100, valid addresses for rows with share > 0, max 10 rows */
...
/** Build properties.creators for collection metadata (nexus-collection: address + share 0–100) */
