...
/**
 * Create flow — Step 4: Deploy & Review (Success).
 * Summary and deploy actions.
 */
    ...
    <div className="nft-create-step-main">
      ...
      <div className="nft-create-summary-card">
        <div className="nft-create-summary-row">
          {collectionImage && (
            <img src={collectionImage} alt="" className="nft-create-summary-thumb" />
          )}
          <div className="nft-create-summary-meta">
            ...
            <ul className="nft-create-summary-list">
              ...
              {phases.length > 0 ? (
                <li>
                  Phases: {phases.length} — {phases.map((p, i) => (p.name || `Phase ${i + 1}`)).join(', ')}
                </li>
              ) : null}
      ...
      <div className="nft-create-warning">
      ...
      {draftSavedAt && (
        <div className="nft-create-draft-saved">✔ Draft saved</div>
      )}
    </div>
  )
}
