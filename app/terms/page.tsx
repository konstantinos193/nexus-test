...
const description =
  'Terms of Service for NeXus Web3 Launchpad - Read our terms and conditions. Understand the rules and guidelines for using our Web3 launchpad platform.'

export const metadata: Metadata = {
  title: pageTitle(title),
  description,
  keywords: ['terms of service', 'NeXus', 'Web3 launchpad', 'terms and conditions'],
  ...
  openGraph: {
    ...
    title: pageTitle(title),
    description,
    images: [{ url: absoluteUrl(ogImagePath), width: 1200, height: 630, alt: 'NeXus – Terms of Service' }],
  },
  twitter: {
