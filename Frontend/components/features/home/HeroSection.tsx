                  ...
                  <Link href={`/drops/${collection.slug ?? collection.id}`} className={styles.slideLink}>
                    <div className={styles.featuredCard}>
                      ...
                      <div className={styles.bannerContainer}>
                        {/* Image wrapper - because Next.js Image needs a positioned parent
                            We use fill to make it responsive (because fixed sizes are for boomers) */}
                        <div className={styles.bannerImageWrapper}>
                          {/* Use regular img tag for SVG API routes - Next.js Image doesn't support API routes
                              SVG is already optimized, so we don't need Next.js Image optimization */}
                          <img
