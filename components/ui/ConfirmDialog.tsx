...
/**
 * Custom confirmation dialog — replaces native window.confirm() with a styled modal.
 * Used for replace confirmations, leave-page prompts, etc.
 */
...
export default function ConfirmDialog({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <h2 id="nft-create-confirm-title" className="nft-create-confirm-title">
          {title}
        </h2>
        <p id="nft-create-confirm-message" className="nft-create-confirm-message">
          {message}
        </p>
