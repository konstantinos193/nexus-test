...
/**
 * CreateStep3Deploy - Step 3: Mint Phases.
 * Configure launch phases with timing, pricing, and allowlists.
 * Because "just launch it" was never a strategy.
 *
              ...
              <div key={i} className={`nft-create-phase-card ${phase.phaseType === 'allowlist' ? 'nft-create-phase-card--allowlist' : ''}`}>
                <div className="nft-create-phase-card-header">
                  ...
                  <div className="nft-create-phase-card-title-wrap">
                    <input type="text" className="nft-create-phase-card-title-input" placeholder={phase.phaseType === 'allowlist' ? 'Whitelist Phase' : 'Public Phase'} value={phase.name} onChange={(e) => updatePhase(i, 'name', e.target.value)} />
                ...
                <div className="nft-create-phase-card-body">
                    ...
                    <div className="nft-create-phase-schedule-grid">
                      ...
                      <div className="nft-create-phase-input-group">
                        <div className="nft-create-phase-end-toggle-row">
                          ...
                          <button type="button" role="switch" aria-checked={phase.useEndDateTime === 'true'} className={`nft-create-phase-end-toggle ${phase.useEndDateTime === 'true' ? 'nft-create-phase-end-toggle--on' : ''}`} onClick={() => setPhaseUseEndMint(i, phase.useEndDateTime !== 'true')}>
                  ...
                  {phase.phaseType === 'allowlist' && (
                    <div className="nft-create-phase-section nft-create-phase-section--allowlist">
                      ...
                      <textarea className="nft-create-phase-allowlist-input" placeholder="Enter wallet addresses, one per line or comma-separated..." rows={5} value={phase.allowlistRaw} onChange={(e) => updatePhase(i, 'allowlistRaw', e.target.value)} />
...
// Coded by Juan - phases, schedules, allowlists. Launch like a pro.
