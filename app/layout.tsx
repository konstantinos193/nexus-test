...
import ClientOnlyWalletProvider from '@/components/providers/ClientOnlyWalletProvider'
import LoggingErrorBoundary from '@/components/providers/LoggingErrorBoundary'
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    site: twitterHandle, // Twitter handle for @MartechNetworks
...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en" className="dark">
      ...
      <body className={`${plusJakarta.variable} ${plusJakarta.className} font-sans bg-dark-bg-primary text-dark-text-primary min-h-screen antialiased`} suppressHydrationWarning>
